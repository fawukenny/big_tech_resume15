  ...
  return (
    <section className="card p-6 sm:p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-xl bg-[var(--surface-muted)]/50 p-4 sm:p-5 border border-[var(--border)]">
      ...
      <div className="mt-6">
        <div className="h-3 rounded-full bg-[var(--surface-muted)] overflow-hidden flex">
          <div
